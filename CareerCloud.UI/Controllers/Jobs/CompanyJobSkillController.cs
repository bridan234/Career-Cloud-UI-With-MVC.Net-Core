...
namespace CareerCloud.UI.Controllers.Jobs
{
    public class CompanyJobSkillController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Job,Skill,SkillLevel,Importance,TimeStamp")] CompanyJobSkillPoco companyJobSkillPoco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Job,Skill,SkillLevel,Importance,TimeStamp")] CompanyJobSkillPoco companyJobSkillPoco)
        {
